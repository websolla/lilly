								...
								<div class="tab-content">
													...
													<form method="post" action="{{ url('admin/'.$itemsnames.'/'.$items->id) }}"  enctype="multipart/form-data">
														...
														<div class="row">
															<div class="col-lg-6 p-t-20">
																<label>Address {{ $language['name'] }}</label>
																<div
																class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
																<input value="{{ $items->address[$key] }}" type="text" name="address[{{$key}}]" class="mdl-textfield__input ckeditor">
									...
									<div class="col-lg-12 p-t-20">
										<div
											...
											<input type="text" name="map" class="mdl-textfield__input" value="{{ $items->map }}">
											<label >Map</label>
