...
jQuery(function () { // This Method To make Auto Selected On Nav Menu
    ...
    $(document).ready(function(){
        $(document).on('click', '#img-but', function(){
            $('#open-file'); // To Open Input Image With href Button
        });

        // First Child To Append
        $('.tab-language').first().addClass('active');
        
        $('#tab-head').first().addClass('show active');



        $(document).on('change', '#gender', function(){ //Gender For women To Show Period Type And Hide For Mens
